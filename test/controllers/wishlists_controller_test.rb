...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { item_id: @wishlist.item_id, quantity: @wishlist.quantity, shopper_id: @wishlist.shopper_id } }, as: :json
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { item_id: @wishlist.item_id, quantity: @wishlist.quantity, shopper_id: @wishlist.shopper_id } }, as: :json
    assert_response 200
  end
